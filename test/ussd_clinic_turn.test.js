...
var fixtures_turn = require("./fixtures_turn")();
var fixtures_openhim = require("./fixtures_jembi_dynamic")();

describe("ussd_clinic_turn", function() {
    var app;
    var tester;
    ...
    beforeEach(function() {
        ...
        tester.setup.config.app({
            ...
            sms_registrations_enabled: true,
    ...
    describe("state_get_contact", function() {
        ...
        it("should retry HTTP call when Turn is down", function() {
            return tester
                .setup(function(api) {
                    api.http.fixtures.add(
                        fixtures_turn.get_contact({
                ...
                .check(function(api){
                    ...
                    api.http.requests.forEach(function(request){
                        assert.equal(request.url, "https://turn/v1/contacts/27820001001/profile");
                    });
    ...
    describe("state_accept_popi", function() {
        ...
        it("should go to state_popi_pp_sms if the user input option 2 on state_accept_popi", function() {
            return tester
                ...
                .setup.config.app({ sms_registrations_enabled: true })
                .setup(function(api) {
                  api.http.fixtures.add(
                  ...
                  api.http.fixtures.add(
                    fixtures_turn.start_journey({
                        journey_uuid: "popi-sms-journey-uuid",
                        wa_id: "27123456789"
                    })
                  );
                })
    ...
    describe("state_send_popi_template_message", function() {
        ...
        it("should send a whatsapp template and fail - SMS registrations disabled", function() {
            return tester
            .setup.config.app({ sms_registrations_enabled: false })
            .setup(function(api) {
              api.http.fixtures.add(
                  fixtures_hub.send_whatsapp_template_message(
                    "+27123456789",
