        ...
        beforeEach(function() {
            ...
            tester
                ...
                .setup(function(api) {
                    ...
                    fixtures_Jembi().forEach(api.http.fixtures.add); // 160 - 169
            ...
            describe("new user", function() {
                it("should give 3 options", function() {
                    return tester
                        ...
                        .check(function(api) {
                            utils.check_fixtures_used(api, [50, 160, 163]);
                        })
                        .run();
                });
        ...
        describe("self registration completion", function() {
            ...
            it("should send welcome sms", function() {
                return tester
                    ...
                    .check(function(api) {
                        utils.check_fixtures_used(api, [50, 100, 150, 160, 163]);
                    })
                    .run();
                });
        });
        ...
        describe("other registration completion", function() {
            ...
            it("should send welcome sms", function() {
                return tester
                    ...
                    .check(function(api) {
                        utils.check_fixtures_used(api, [50, 101, 150, 160, 161, 163]);
                    })
                    .run();
            });
        });
